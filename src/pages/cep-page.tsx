...
export default function CepPage() {
  ...
  const [cartTotal, setCartTotal] = useState(49.90);
    ...
    if (cartRaw) {
      try {
        ...
        if (cart.qty && cart.qty > 0) {
          setCartQty(cart.qty);
          setCartTotal(cart.totalPrice ?? 49.90 * cart.qty);
        }
      } catch { /* ignored */ }
    }
  ...
  const originalPrice = 97.90 * cartQty;
  ...
  return (
    <div className="min-h-screen bg-[#EBEBEB] mx-auto max-w-[480px] shadow-xl flex flex-col pb-[100px]">
      ...
      <div className="bg-white mx-0 px-4 py-3 flex items-center gap-3">
        <img src="/images/figurinhas-copa.png" alt="produto" className="w-14 h-14 object-contain rounded border border-gray-100" />
