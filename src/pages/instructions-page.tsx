...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Verifique o nome do recebedor, o valor de R$ 49,90 e a instituição. Só finalize quando os dados estiverem corretos.",
  },
  {
    icon: ShieldCheck,
...
async function callPixApi(checkoutData: {
  ...
  const res = await fetch("/api/pix/create", {
    ...
    body: JSON.stringify({
      ...
      productName: "Kit 140 Figurinhas Copa Do Mundo 2026",
    }),
  });
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm text-gray-800 font-medium leading-snug line-clamp-1">
              Kit 140 Figurinhas Do Álbum Copa Do Mundo 2026...
            </p>
